...
const inferWalletWebsite = (walletName: string): string => {
  ...
  if (name.includes('nightly')) return 'https://nightly.app/';
  if (name.includes('ethos')) return 'https://ethoswallet.xyz/';
  if (name.includes('suiet')) return 'https://suiet.app/';
  if (name.includes('sui')) return 'https://sui.io/';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <div className="relative px-6 py-6 border-b border-white/[0.06]">
              ...
              <h2 id="wallet-modal-title" className="text-xl font-black text-white tracking-tight mb-1">
                Connect Wallet
              </h2>
